...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-white shadow-md px-6 py-4 max-w-7xl mx-auto flex justify-between items-center">
      <Link to="/" className="flex items-center gap-2">
        <img
          ...
          className="w-9"
        />
        <span className="text-2xl font-bold text-gray-800 hover:text-green-500">
          E-Commerce
        </span>
      </Link>
      ...
      >
        ...
        <div className="relative">
          ...
          {showDetails && (
            <div
              ref={detailsRef}
              className="absolute right-0 top-10 bg-white shadow-lg p-4 rounded-md border w-48"
            >
